			      		...
			      		<div class="dash-unit">
					  		...
					  		<div style="padding:10px">
					        	...
					        	<form method = "POST" action = "update_employee.php">
	                        		...
	                        		<div id = "login">
										<?php 
											$usersql = mysqli_query($con,"SELECT * FROM users WHERE employee_id='$row1[employee_id]' ORDER BY fullname DESC");
											$row2=mysqli_fetch_array($usersql);
										?>
		                        		<input style = "<?php echo ($row1['access']==1) ? '' : 'display:none' ?>" type="text" name="username" id = "username" class="form-control" placeholder="Username" autocomplete="off" value="<?php echo (!empty($row2['username'])) ? $row2['username'] : '' ?>">
					  					<span id="suggestion-username"></span>
						        ...
						        <tbody>	
						        	<?php 
						          	...
						          	<tr class="gradeA">
							           ...
							           <td><?php echo ($row['department_id']!=0) ?  getInfo($con, 'department_name', 'department', 'department_id',  $row['department_id']) : '';?></td>
